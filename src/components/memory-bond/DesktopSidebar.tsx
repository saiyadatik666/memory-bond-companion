...
export function DesktopSidebar({
  ...
  return (
    <aside
      ...
      className="hidden lg:flex flex-col w-64 xl:w-72 shrink-0 bg-white/95 backdrop-blur-md border-r border-[#E8EEF5] min-h-screen sticky top-0 px-4 py-5 shadow-[2px_0_16px_rgba(15,36,62,0.02)] z-20 justify-between select-none"
    >
      <div>
        {/* Brand Header */}
