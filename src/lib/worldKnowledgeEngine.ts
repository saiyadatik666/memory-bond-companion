...
const VERIFIED_FACTS: Array<{
  ...
  },
  {
    ...
    answers: {
      hi: "मैं आपके लिए आज का मौसम देख सकता हूँ, अगर मौसम सेवा उपलब्ध है। आप किस शहर का मौसम जानना चाहते हैं? वर्तमान में लाइव मौसम सेवा कनेक्ट नहीं है।",
      gu: "હું તમારા માટે આજનું હવામાન જોઈ શકું છું, જો હવામાન સેવા ઉપલબ્ધ હોય. તમે કયા શહેરનું હવામાન જાણવા માંગો છો? હાલમાં લાઈવ હવામાન સેવા કનેક્ટેડ નથી.",
      en: "I can check today's weather for you if a weather service is connected. Which city's weather would you like to know? Real-time live weather service is currently unavailable.",
      as: "বতৰ সেৱা সংযোগ থাকিলে মই আজিৰ বতৰ চাব পাৰোঁ। আপুনি কোনখন চহৰৰ বতৰ জানিব বিচাৰে? এতিয়া লাইভ বতৰ সেৱা উপলব্ধ নহয়।",
      bn: "আবহাওয়া সেবা সংযুক্ত থাকলে আমি আজকের আবহাওয়া দেখে দিতে পারি। আপনি কোন শহরের আবহাওয়া জানতে চান? বর্তমানে লাইভ আবহাওয়া সেবা সংযুক্ত নেই।",
      mr: "हवामान सेवा उपलब्ध असल्यास मी आजचे हवामान तपासू शकतो. तुम्हाला कोणत्या शहराचे हवामान जाणून घ्यायचे आहे? सध्या थेट हवामान सेवा उपलब्ध नाही.",
    },
  },
  {
    // Ratan Tata
